...
<head>
   <!-- Required meta tags-->
    ...
    <!-- Title Page-->
    <title>Film Me | Booked Events</title>
                        ...
                        <ul class="metismenu" id="menu">
                            ...
                            <li class="active">
                                ...
                                <ul class="collapse">
                                    ...
                                    <li class="active"><a href="bookedEvents.php">Booked</a></li>
                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            <h4 class="page-title pull-left">Booked Events</h4>
     ...
     <?php } ?>
            ...
            <div class="main-content-inner">
               ...
               <?php
                          ...
                          $query = "SELECT * FROM events WHERE status='booked' ORDER BY date_added ASC";
