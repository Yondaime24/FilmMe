...
<head>
    ...
    <!-- Title Page-->
    <title>Film Me | View Event</title>
...
<br>
          ...
          ?>
            ...
            <div>
                ...
                <a class="btn btn-block btn-primary" href="processing.php?customer_id=<?php echo $row['user_id'];?>&&event_id=<?php echo $row['event_id'];?>&&photographer_id=<?php echo $_SESSION['user']['user_id'];?>"  onClick="return confirm('Are you sure you want to accept this event?' )">Accept Event</a>
          ...
          <?php }else if($status=="booked"){ ?> 
            ...
            <?php
                $query=mysqli_query($db,"SELECT * FROM bookings WHERE customer_id='".$user_id."' && status = 'booked'")or die(mysqli_error());
                while($row=mysqli_fetch_array($query)){
            ?>
          ...
          ?>
               <?php
                $query=mysqli_query($db,"SELECT * FROM bookings WHERE customer_id='".$user_id."' && status = 'finished'")or die(mysqli_error());
                while($row=mysqli_fetch_array($query)){
            ?>
         ...
         <?php
          ...
          ?>
           ...
           <center>
              <h4 style="color: #2ecc71">Event Processing!</h4>
                 <a class="btn btn-block btn-primary" href="processing.php?customer_id=<?php echo $user_id;?>&&event_id=<?php echo $event_id;?>&&photographer_id=<?php echo $_SESSION['user']['user_id'];?>">Go Back To Payment</a>
            </center>
