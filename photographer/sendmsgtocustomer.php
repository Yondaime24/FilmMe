...
<!-- header area end -->
    ...
    <div class="login-area">
        <div class="container">
            <div class="login-box">
            <form id="messageForm" action="sendmsgtocustomer.php" method="post">
          ...
          <div class="form-group" hidden="hidden">
                <label for="sd" class="control-label mb-1">Customer ID</label>
                <input id="sd" name="customer_id" type="text" class="form-control" value="<?php echo $row['user_id'];?>" readonly>
            </div>

            <div class="form-group">
                <label for="locId" class="control-label mb-1">To</label>
                <input id="locId" name="customer_name" type="text" class="form-control" value="<?php echo $row['fname'];?> <?php echo $row['mname'];?> <?php echo $row['lname'];?>" readonly>
            </div>
         ...
         <?php } ?>
             ...
             <div class="form-group">
                ...
                <input id="locId" name="photographer_name" type="text" class="form-control" value="<?php echo $_SESSION['user']['fname']; ?> <?php echo $_SESSION['user']['mname']; ?> <?php echo $_SESSION['user']['lname']; ?>" readonly>
            </div>
            ...
            <div class="form-group" hidden>
                <label for="sadas" class="control-label mb-1">Residential Address</label>
                <input name="photographer_address" id="sadas" type="text" class="form-control" value="<?php echo $_SESSION['user']['residential_address']; ?>" readonly="readonly">
            </div>
            ...
            <div class="form-group validate">
              ...
              <div>
                <button  class="btn btn-success btn-block" type="submit" name="photographerMessage">Send</button>
              </div>
