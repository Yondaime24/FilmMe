...
<!-- header area end -->
    ...
    <div class="login-area">
        <div class="container">
            <div class="login-box">
        <form id="reservationForm" action="viewEvent.php" method="post">
            ...
            <div class="form-group" hidden="hidden">
                ...
                <input id="userID" name="photographer_id" type="text" class="form-control" value="<?php echo $_SESSION['user']['user_id']; ?>" readonly>
            </div>

            <div class="form-group">
              <label for="useasdasrID" class="control-label mb-1">Photographer Name</label>
              <input id="useasdasrID" name="photographer_name" type="text" class="form-control" value="<?php echo $_SESSION['user']['fname']; ?> <?php echo $_SESSION['user']['mname']; ?> <?php echo $_SESSION['user']['lname']; ?>" readonly>
            </div>

            <div class="form-group">
                <label for="residentialAddress" class="control-label mb-1">Residential Address</label>
                <input id="residentialAddress" name="photographer_address" type="text" class="form-control" value="<?php echo $_SESSION['user']['residential_address']; ?>" readonly>
            </div>

            <div class="form-group">
                <label for="contactNumber" class="control-label mb-1">Contact Number</label>
                 <input name="photographer_contact" id="contactNumber" type="text" class="form-control" value="<?php echo $_SESSION['user']['contact_number']; ?>" readonly="readonly">
            </div>

             <div class="form-group">
                <label for="inputNumber" class="control-label mb-1">Email Address</label>
                <input name="photographer_email" id="inputNumber" type="text" class="form-control" value="<?php echo $_SESSION['user']['email_address']; ?>" readonly="readonly">
            </div>
...
<br>
          ...
          <div class="form-group">
              <label for="useasdasrID" class="control-label mb-1">Customer Name</label>
              <input id="useasdasrID" name="photographer_name" type="text" class="form-control" value="<?php echo $row['customer_name']; ?>" readonly>
            </div>

            <div class="form-group">
                <label for="residentialAddress" class="control-label mb-1">Customer Address</label>
                <input id="residentialAddress" name="photographer_address" type="text" class="form-control" value="<?php echo $row['customer_address']; ?>" readonly>
            </div>

            <div class="form-group">
                <label for="contactNumber" class="control-label mb-1">Customer Contact #</label>
                 <input name="photographer_contact" id="contactNumber" type="text" class="form-control" value="<?php echo $row['customer_contact']; ?>" readonly="readonly">
            </div>

             <div class="form-group">
                <label for="inputNumber" class="control-label mb-1">Customer Email</label>
                <input name="photographer_email" id="inputNumber" type="text" class="form-control" value="<?php echo $row['customer_email']; ?>" readonly="readonly">
            </div>
          ...
          <?php }else if($status=="booked"){ ?> 
            ...
            <?php
                $query=mysqli_query($db,"SELECT * FROM bookings WHERE booking_id='".$booking_id."' && status = 'booked'")or die(mysqli_error());
                while($row=mysqli_fetch_array($query)){
            ?>

            <div class="form-group validate">
                <label for="inputNumber" class="control-label mb-1">You Booked This On:</label>
            ...
            <center>
              <h4 style="color: blue">Event Booked!</h4>
               <a class="btn btn-block btn-success" href="sendmsgtocustomer.php?user_id=<?php echo $row['customer_id'];?>&&event_id=<?php echo $row['event_id'];?>">Message Customer</a>
            </center>
          ...
          <?php }else if($status=="finished"){ ?> 
            <?php
                $query=mysqli_query($db,"SELECT * FROM bookings WHERE customer_id='".$customer_id."' && status = 'finished'")or die(mysqli_error());
                while($row=mysqli_fetch_array($query)){
            ?>
          ...
          ?>
               <?php
                $query=mysqli_query($db,"SELECT * FROM bookings WHERE customer_id='".$user_id."' && status = 'canceled'")or die(mysqli_error());
                while($row=mysqli_fetch_array($query)){
            ?>
          ...
          ?>
           <?php }?>
              ...
              <div style="margin-top: 10px;">
                <a class="btn btn-block btn-secondary" href="photographerHome.php">Cancel</a>
              </div>
                </form>
            </div>
        </div>
