...
<img src="../images/download.jpeg" width="150">
            ...
            ?>
                ...
                <?php 
                    $status=$row['status']; 
                if ($status=='processing, mostly takes an hour.') { ?>
                                ...
                                <a class="btn btn-block btn-success" href="processing2.php?customer_id=<?php echo $customer_id  ?>&&event_id=<?php echo $event_id ?>&&photographer_id=<?php echo $photographer_id ?>">Refresh Page</a>
