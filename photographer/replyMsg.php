...
<head>
    ...
    <!-- Title Page-->
    <title>Film Me | Admin Message</title>
...
<!-- header area end -->
    ...
    <div class="login-area">
        <div class="container">
            <div class="login-box">
                <form id="messageForm" action="replyMsg.php" method="post">
                    <div class="login-form-head">
                        <h4>Admin Message</h4>
                    </div>
                    <div class="login-form-body">
       <div class="form-group" hidden="hidden">
            <label for="sda" class="control-label mb-1">photographer ID:</label>
            <input id="sda" type="text" name="photographer_id" class="form-control" value="<?php echo $_SESSION['user']['user_id']; ?>" readonly>
        </div>

        <div class="form-group" hidden="hidden">
            <label for="sda" class="control-label mb-1">photographer Name:</label>
         ...
         <div class="form-group" hidden="hidden">
            <label for="sda" class="control-label mb-1">photographer Contact:</label>
            <input id="sda" type="text" name="contact_number" class="form-control" value="<?php echo $_SESSION['user']['contact_number']; ?>" readonly>
        </div>

         <div class="form-group" hidden="hidden">
            <label for="sda" class="control-label mb-1">photographer Email:</label>
      ...
      ?>
            ...
            <div class="form-group" hidden="hidden">
                ...
                <input id="userID" name="admin_id" type="text" class="form-control" value="<?php echo $row['admin_id']; ?>" readonly>
            </div>
          ...
          <?php }?>
              ...
              <div>
                <button  class="btn btn-success btn-block" type="submit" name="photographerMsgAdmin">Send Reply</button>
              </div>
