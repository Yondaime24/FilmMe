...
<head>
   <!-- Required meta tags-->
    ...
    <!-- Title Page-->
    <title>Film Me | Pending Events</title>
                    ...
                    <nav>
                        <ul class="metismenu" id="menu">
                            ...
                            <li class="active">
                                ...
                                <ul class="collapse">
                                    <li class="active"><a href="pendingEvents.php">Pending</a></li>
                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            <h4 class="page-title pull-left">Pending Events</h4>
            ...
            <div class="main-content-inner">
                <div class="row">
                    ...
                    <div class="col-12 mt-5">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="header-title">Pending Events</h4>
                                <div class="data-tables datatable-primary">
                 <?php
            
                          $query = "SELECT * FROM events WHERE status='pending' ORDER BY date_added ASC";
                              ...
                              while($res = mysqli_fetch_array($result)) {     
                                ...
                                // if ($res['status']=='pending') {
                                  ...
                                  echo "<td class=\"text-center\">
                                      <a class=\"btn btn-outline-info btn-sm btn-block\" href=\"viewEvent.php?event_id=$res[event_id]&&customer_id=$res[user_id]\">View</a>
                                      <a class=\"btn btn-outline-success btn-sm btn-block\" href=\"sendmsgtocustomer.php?event_id=$res[event_id]&&user_id=$res[user_id]\">Message</a>
                                       </td>";
                                // }else if ($res['status']=='booked') {
                                //      echo "<td style=\"color: blue;\">".$res['status']."</td>";
                                //       echo "<td class=\"text-center\">
                                //       <a class=\"btn btn-outline-success btn-sm btn-block\" href=\"viewEvent.php?event_id=$res[event_id]&&user_id=$res[user_id]\">View</a>
                                //        </td>";
                                // }else if ($res['status']=='finished') {
