...
<head>
    ...
    <!-- Title Page-->
    <title>Film Me | Message Admin</title>
...
<!-- header area end -->
    ...
    <div class="login-area">
        <div class="container">
            <div class="login-box">
             <form id="messageForm" action="messageAdmin.php" method="post">
                ...
                <label for="textArea" class="control-label mb-1">Message</label>
                 <textarea name="message" id="textarea-input" rows="9" placeholder="Input Message Here..." class="form-control"></textarea>
                        ...
                        <div class="submit-btn-area">
                            <button id="form_submit" type="submit" name="photographerMsgAdmin">Send <i class="ti-arrow-right"></i></button>
                            <br><br>
                            <a href="photographerhome.php" class="btn btn-block btn-secondary">Cancel</a>
                        </div>
                    </div>
                </form>
            </div>
