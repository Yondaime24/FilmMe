...
<head>
    ...
    <!-- Title Page-->
    <title>Film Me | Customer Dashboard</title>
...
<body>
                ...
                <div class="menu-inner">
                    <nav>
                        <ul class="metismenu" id="menu">
                            ...
                            <li class="active"><a href="addEvent.php"><i class="ti-plus"></i> <span>add event</span></a></li>
                            <li><a href="myEvents.php"><i class="ti-calendar"></i> <span>my events</span></a></li>
   ...
   ?>
                        ...
                        <!-- Server side start -->
                            <div class="col-12">
                                <div class="card ">
                                    <div class="card-body">
                                        <h4 class="header-title">My Contact Details</h4>

                                    <form id="event" method="post" action="addEvent.php" enctype="multipart/form-data">
                                          ...
                                          <div class="form-label-group">
                                            ...
                                            <div class="form-row">
                                                <div class="col-md-6 mb-3">
                                                  ...
                                                  <input type="text" id="firstName" class="form-control" value="<?php echo $_SESSION['user']['fname']?> <?php echo $_SESSION['user']['mname']?> <?php echo $_SESSION['user']['lname']?>" name="customer_name" readonly> 
                                                </div>
                                                   <div class="col-md-6 validate">
                                                      <div class="form-label-group">
                                                        <label for="contactNumber">Contact Number</label>
                                                        <input type="text" id="contactNumber" class="form-control" value="<?php echo $_SESSION['user']['contact_number']?>" name="contact_number" readonly>
                                                      </div>
                                                    </div>
                                              </div>
                                                 ...
                                                 <div class="form-group validate">
                                                  <div class="form-label-group">
                                                    ...
                                                    <input type="text" id="inputAddress" class="form-control" value="<?php echo $_SESSION['user']['residential_address']?>" name="residential_address" readonly>
                                                  </div>
                                                </div>
                                                  ...
                                                  <div class="form-row">
                                                    <div class="col-md-6 validate">
                                                      <div class="form-label-group">
                                                        ...
                                                        <input type="email" id="emailAddress" class="form-control" value="<?php echo $_SESSION['user']['email_address']?>" name="email_address" readonly> 
                                                      </div>
                                                    </div>
                                                  </div>
                                                </div>
                                                ...
                                                <center>
                                                  ...
                                                  <div>
                                                    <a  class="btn btn-primary text-white" href="editProfile.php">Edit Details</a>
                                                  </div>
   ...
   <?php } ?>
                                                ...
                                                <center>
                                                    <div>
                                                    <button  class="btn btn-success" type="submit" name="addEventBtn">Add</button>
                                                  </div>
                                                </center>
