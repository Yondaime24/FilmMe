            ...
            <div class="row">
              ...
              <div class="col-6 ">
                <div class="form-group validate">
                 ...
                 <input name="event_date" id="inputNumber" type="date" class="form-control" value="<?php echo $row['event_date'];?>" readonly>
                </div>
              </div>
             </div>
       ...
       <?php
          ...
          <?php }else if($status=="booked"){ ?> 
            ...
            <br>
             ...
             <div class="form-group validate">
                <label for="inputNumber" class="control-label mb-1">Photographer Name</label>
                <input name="customer_name" id="inputBlock" type="text" class="form-control" value="<?php echo $row['photographer_name'];?>" readonly>
            </div>

             <div class="form-group validate">
                <label for="inputNumber" class="control-label mb-1">Photographer Address</label>
                <input name="customer_address" id="inputBlock" type="text" class="form-control" value="<?php echo $row['photographer_address'];?>" readonly>
            </div>
             ...
             <div class="row">
              <div class="col-6 ">
                <div class="form-group validate">
                 ...
                 <input name="customer_contact" id="inputBlock" type="text" class="form-control" value="<?php echo $row['photographer_contact'];?>" readonly>
                </div>
              </div>
              <div class="col-6 ">
                <div class="form-group validate">
                 <label for="inputNumber" class="control-label mb-1">Email Address</label>
                 <input name="customer_email" id="inputNumber" type="text" class="form-control" value="<?php echo $row['photographer_email'];?>" readonly>
                </div>
              </div>
             </div>
            ...
            <center>
              <h4 style="color: blue">Event Booked!</h4>
               ...
               <a class="btn btn-block btn-success" href="sendmsgtophotographer.php?event_id=<?php echo $row['event_id'];?>&&user_id=<?php echo $row['customer_id'];?>">Message photographer</a>
            </center>
          ...
          ?>
              <div>
                <a class="btn btn-block btn-success" href="editReservation.php?event_id=<?php echo $row['event_id'];?>&&user_id=<?php echo $row['user_id'];?>">Edit</a>
              </div>
         <?php }
          ?>
           <?php }?>
