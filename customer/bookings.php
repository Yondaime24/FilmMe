...
<head>
   <!-- Required meta tags-->
    ...
    <!-- Title Page-->
    <title>Film Me | My Bookings</title>
            ...
            <div class="main-content-inner">
                <div class="row">
                    ...
                    <?php
                          ...
                          $query = "SELECT * FROM bookings WHERE customer_id='$user_id' ORDER BY event_date ASC";
                   ...
                   ?>  
                            ...
                            if($result){
                              while($res = mysqli_fetch_array($result)) {     
                                echo "<tr>";
                                  echo "<td>".$res['photographer_name']."</td>";
                                  echo "<td>".$res['photographer_email']."</td>";
                                  echo "<td>".$res['photographer_contact']."</td>";
                                ...
                                if ($res['status']=='booked') {
                                     ...
                                     echo "<td class=\"text-center\">
                                      <a class=\"btn btn-outline-info btn-sm btn-block\" href=\"viewBooking.php?booking_id=$res[booking_id]&&customer_id=$res[customer_id]&&event_id=$res[event_id]\">View</a>
                                       <a class=\"btn btn-outline-success btn-sm btn-block\" href=\"sendmsgtophotographer.php?event_id=$res[event_id]&&user_id=$res[customer_id]\">Message</a>
                                       </td>";
                                }else if ($res['status']=='finished') {
                                     echo "<td style=\"color: #2ecc71;\">".$res['status']."</td>";
                                     echo "<td class=\"text-center\">

                                      <a class=\"btn btn-block btn-outline-primary\" href=\"printInvoice.php?booking_id=$res[booking_id]\">View Receipt</a>
