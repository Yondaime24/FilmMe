...
<head>
    ...
    <!-- Title Page-->
    <title>Film Me | Customer Admin Message</title>
    ...
    <div class="login-area">
        <div class="container">
           ...
           <div class="form-group" hidden="hidden">
            <label for="sda" class="control-label mb-1">Customer ID:</label>
            <input id="sda" type="text" name="customer_id" class="form-control" value="<?php echo $_SESSION['user']['user_id']; ?>" readonly>
        </div>
      ...
      ?>
            ...
            <div class="form-group validate">
                <label for="textArea" class="control-label mb-1"><h5>Message:</h5></label>
                 <textarea id="textarea-input" rows="9" class="form-control" readonly="on" style="border: none; height: 100px"><?php echo $row['message']; ?></textarea>
            </div>
          ...
          <?php }?>
                        <div class="submit-btn-area">
                            <button id="form_submit" type="submit" name="customerMsgAdmin">Send Reply <i class="ti-arrow-right"></i></button>
                        </div>
                    </div>
                </form>
            </div>
