<?php 
  ...
  $query ="UPDATE `photographertocustomermsg` SET `status` = 'read' WHERE `msg_id` = $msg_id;";
  performQuery($query);
...
<!-- header area end -->
    ...
    <div class="login-area">
        <div class="container">
            ...
            <input id="sda" type="text" name="customer_name" class="form-control" value="<?php echo $_SESSION['user']['fname']; ?> <?php echo $_SESSION['user']['mname']; ?> <?php echo $_SESSION['user']['lname']; ?>" readonly>
        </div>

         <div class="form-group" hidden="hidden">
            <label for="sda" class="control-label mb-1">Customer Contact:</label>
            <input id="sda" type="text" name="customer_contact" class="form-control" value="<?php echo $_SESSION['user']['contact_number']; ?>" readonly>
        </div>

         <div class="form-group" hidden="hidden">
            <label for="sda" class="control-label mb-1">Customer Email:</label>
            <input id="sda" type="text" name="customer_email" class="form-control" value="<?php echo $_SESSION['user']['email_address']; ?>" readonly>
        </div>

          <div class="form-group" hidden="hidden">
            <label for="sda" class="control-label mb-1">Customer Residential Address:</label>
            <input id="sda" type="text" name="customer_address" class="form-control" value="<?php echo $_SESSION['user']['residential_address']; ?>" readonly>
        </div>


      <?php
          $query=mysqli_query($db,"SELECT * FROM photographertocustomermsg WHERE msg_id='".$msg_id."'")or die(mysqli_error());
      ...
      ?>
            ...
            <div class="form-group" hidden="hidden">
             ...
             <div class="form-group">
                ...
                <input id="locId" type="text" name="photographer_name" class="form-control" value="<?php echo $row['photographer_name']; ?>" readonly>
            </div>
            ...
            <div class="form-group">
                <label for="status" class="control-label mb-1">Photographer Residential Address:</label>
                <input id="status" name="photographer_address" type="text" class="form-control" value="<?php echo $row['photographer_address']; ?>" readonly>
            </div>
          ...
          <?php }?>
                        <div class="submit-btn-area">
                            <button id="form_submit" type="submit" name="replyphotographermsg">Send Reply <i class="ti-arrow-right"></i></button>
                        </div>
                    </div>
                </form>
            </div>
