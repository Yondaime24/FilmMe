...
<head>
    ...
    <!-- Title Page-->
    <title>Film Me | Edit Event</title>
            ...
            <div class="row">
              <div class="col-6 ">
                <div class="form-group validate">
                 ...
                 <input name="event_name" id="inputBlock" type="text" class="form-control" value="<?php echo $row['event_name'];?>">
                </div>
              </div>
              <div class="col-6 ">
                <div class="form-group validate">
                 <label for="inputNumber" class="control-label mb-1">Event Date</label>
                 <input name="event_date" id="inputNumber" type="date" class="form-control" value="<?php echo $row['event_date'];?>">
                </div>
              </div>
             </div>

            <div class="form-group validate">
                <label for="asdas" class="control-label mb-1">Event Price (Recent Price: &#8369;<?php echo $row['event_price'];?>)</label>
                <input name="event_price" id="asdas" type="text" class="form-control" placeholder="Enter New Price">
            </div>

            <div class="form-group validate">
                <label for="inputNumber" class="control-label mb-1">Event Location</label>
                <input name="event_loc" id="inputNumber" type="text" class="form-control" value="<?php echo $row['event_loc'];?>">
            </div>

          <?php }?>
      
                        <div class="submit-btn-area">
                            <button id="form_submit" type="submit" name="updateEvent">Update <i class="ti-arrow-right"></i></button>
                            <br><br>
