                ...
                <div class="menu-inner">
                    <nav>
                        <ul class="metismenu" id="menu">
                            ...
                            <li class="active"><a href="userHome.php"><i class="ti-dashboard"></i> <span>dashboard</span></a></li>
                            ...
                            <div class="single-report mb-xs-30">
                                ...
                                <div class="s-report-inner pr--20 pt--30 mb-3">
                                    ...
                                    <?php
                                        ...
                                        $query = "SELECT * from `events` where `status` = 'pending' && `user_id` = '$user_id'";
                                        if(count(fetchAll($query))>0){
                                    ?>
                                  ...
                                  if(count(fetchAll($query))==1){
                                    ...
                                    <div class="s-report-title d-flex justify-content-between">
                                        <h4 class="header-title mb-0">Added Event</h4>
                                  ...
                                  ?>
                                       <div class="s-report-title d-flex justify-content-between">
                                        <h4 class="header-title mb-0">Added Events</h4>
                        ...
                        <div class="col-md-4">
                            <div class="single-report mb-xs-30">
                                ...
                                <div class="s-report-inner pr--20 pt--30 mb-3">
                                    ...
                                    <?php
                                        $user_id = $_SESSION['user']['user_id'];  
                                        $query = "SELECT * from `bookings` where `status` = 'booked' && `customer_id` = '$user_id' ";
                                        if(count(fetchAll($query))>0){
                                    ?>
                                  ...
                                  if(count(fetchAll($query))==1){
                                    ?>
                                    <div class="s-report-title d-flex justify-content-between">
                                        <h4 class="header-title mb-0">Your Event Has Been Booked</h4>
                                  ...
                                  ?>
                                       <div class="s-report-title d-flex justify-content-between">
                                        <h4 class="header-title mb-0">Your Events Has Been Booked</h4>
                         ...
                         <div class="col-md-4">
                            <div class="single-report mb-xs-30">
                                ...
                                <div class="s-report-inner pr--20 pt--30 mb-3">
                                    ...
                                    <?php
                                        $user_id = $_SESSION['user']['user_id'];  
                                        $query = "SELECT * from `events` where `status` = 'canceled' && `user_id` = '$user_id' ";
                                        if(count(fetchAll($query))>0){
                                    ?>
                                  ...
                                  ?>           
                                    ...
                                    <?php
                                          ...
                                          echo "You Have No Canceled Events Yet!";
                                        }
                                    ?>                                 
                                </div>
                            </a>
                         ...
                         <div class="col-md-4" style="margin-top: 20px;">
                            <div class="single-report mb-xs-30">
                                ...
                                <div class="s-report-inner pr--20 pt--30 mb-3">
                                    ...
                                    <?php
                                        $user_id = $_SESSION['user']['user_id'];  
                                        $query = "SELECT * from `events` where `status` = 'finished' && `user_id` = '$user_id' ";
                                        if(count(fetchAll($query))>0){
                                    ?>
                                  ...
                                  ?>           
                                    ...
                                    <?php
                                          ...
                                          echo "You Have No Finished Events Yet!";
                                        }
                                    ?>                                 
                                </div>
                            </a>
