...
<!-- header area end -->
    ...
    <div class="login-area">
        <div class="container">
            <div class="login-box">
             <form id="messageForm" action="sendmsgtophotographer.php" method="post">
                    <div class="login-form-head">
                        <h4>Message Photographer</h4>
                    </div>
            ...
            <div class="form-group" hidden>
                ...
                <input id="userID" name="customer_id" type="text" class="form-control" value="<?php echo $_SESSION['user']['user_id']; ?>" readonly>
            </div>
        ...
        <?php
          ...
          <div class="form-group" hidden="hidden">
                <label for="sd" class="control-label mb-1">photographer ID</label>
                <input id="sd" name="photographer_id" type="text" class="form-control" value="<?php echo $row['photographer_id'];?>" readonly>
            </div>

            <div class="form-group">
                <label for="locId" class="control-label mb-1">To photographer</label>
                <input id="locId" name="photographer_name" type="text" class="form-control" value="<?php echo $row['photographer_name'];?>" readonly>
            </div>
         ...
         <?php } ?>
             ...
             <div class="form-group">
                ...
                <input id="locId" name="customer_name" type="text" class="form-control" value="<?php echo $_SESSION['user']['fname']; ?> <?php echo $_SESSION['user']['mname']; ?> <?php echo $_SESSION['user']['lname']; ?>" readonly>
            </div>

            <div class="form-group" hidden>
                <label for="contactNumber" class="control-label mb-1">Contact Number</label>
                 <input name="customer_contact" id="contactNumber" type="text" class="form-control" value="<?php echo $_SESSION['user']['contact_number']; ?>" readonly="readonly">
            </div>

             <div class="form-group" hidden>
                <label for="inputNumber" class="control-label mb-1">Email Address</label>
                <input name="customer_email" id="inputNumber" type="text" class="form-control" value="<?php echo $_SESSION['user']['email_address']; ?>" readonly="readonly">
            </div>

            <div class="form-group" hidden>
                <label for="sadas" class="control-label mb-1">Residential Address</label>
                <input name="customer_address" id="sadas" type="text" class="form-control" value="<?php echo $_SESSION['user']['residential_address']; ?>" readonly="readonly">
            </div>
                ...
                <label for="textArea" class="control-label mb-1">Message</label>
                 <textarea name="message" id="textarea-input" rows="9" placeholder="Input Message Here..." class="form-control"></textarea>
                        ...
                        <div class="submit-btn-area">
                            <button id="form_submit" type="submit" name="custmsg">Send <i class="ti-arrow-right"></i></button>
                            <br><br>
