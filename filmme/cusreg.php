...
<!-- header area start -->
    ...
    <div class="login-area login-s2">
        <div class="container">
            <div class="login-box"> 
                <form id="register" action="cusreg.php" method="post" enctype="multipart/form-data">
                   ...
                   <br><br><br><br>   <br><br><br><br>   <br><br><br><br> <br><br><br><br> <br><br><br><br>
                        <div class="submit-btn-area" style="margin-top: 350px;">
                            <button id="form_submit" type="submit" name="registerBtn">Register <i class="ti-arrow-right"></i></button>
                        </div>
                        <div class="form-footer text-center mt-5">
                            <p class="text-muted">Are you a Photographer/Videographer?<a href="pvreg.php"><br>Register Here</a></p>
                        </div>
                    </div>
                </form>
            </div>
