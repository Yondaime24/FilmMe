...
<head>
   <!-- Required meta tags-->
    ...
    <!-- Title Page-->
    <title>Film Me | Photographers</title>
                    ...
                    <nav>
                        <ul class="metismenu" id="menu">
                            ...
                            <li class="active">
                                ...
                                <ul class="collapse">
                                    <li class="active"><a href="photographer.php">View Photographer</a></li>
                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            <h4 class="page-title pull-left">Photographer</h4>
                    ...
                    <div class="col-12 mt-5">
                        <div class="card">
                            <div class="card-body" style="height: 500px;">
                                <!-- <h4 class="header-title">Photographer Profile</h4> -->
                            ...
                            <div class="col-lg-12">
                                <div class="au-card recent-report">
                                    <div class="au-card-inner">
                                        <h3 class="title-2 text-center"> <u> Photographer Profile </u></h3>
                                    <br>
                                    <?php if($row['photo'] != ""): ?>
                                        <img src="../images/<?php echo $row['photo'];?>" width="250"/>
                                    <?php else: ?>
                                        <img src="../images/profile.png" width="250"/>
                                    <?php endif; ?>

                                     <h3 class="title-2" style="position: absolute; top: 100px; left: 350px;">Name: </h3>
                                     <h3 style="position: absolute; top: 100px; left: 450px;"><u><?php echo $row['fname'];?> <?php echo $row['mname'];?> <?php echo $row['lname'];?></h3>

                                     <h3 class="title-2" style="position: absolute; top: 130px; left: 350px;">Age: </h3>
                                     <h3 style="position: absolute; top: 130px; left: 420px;"><u><?php echo $row['age'];?></h3>

                                     <h3 class="title-2" style="position: absolute; top: 160px; left: 350px;">Gender: </h3>
                                     <h3 style="position: absolute; top: 160px; left: 460px;"><u><?php echo $row['gender'];?></h3>

                                     <h3 class="title-2" style="position: absolute; top: 190px; left: 350px;">Birthday: </h3>
                                     <h3 style="position: absolute; top: 190px; left: 470px;"><u><?php echo  date('F j, Y',strtotime($row['birthday']));?></h3>

                                     <h3 class="title-2" style="position: absolute; top: 220px; left: 350px;">Contact Number: </h3>
                                     <h3 style="position: absolute; top: 220px; left: 570px;"><u><?php echo $row['contact_number'];?></h3>

                                    <h3 class="title-2" style="position: absolute; top: 250px; left: 350px;">Email Address: </h3>
                                     <h3 style="position: absolute; top: 250px; left: 540px;"><u><?php echo $row['email_address'];?></h3>

                                     <h3 class="title-2" style="position: absolute; top: 280px; left: 350px;">Residential Address: </h3>
                                     <h6 style="position: absolute; top: 290px; left: 610px;"><u><?php echo $row['residential_address'];?></h6>

                                    <a href="photographer.php" class="btn btn-outline-primary btn-sm" style="position: absolute; top:  350px; left: 397px;">Return</a>
                                    <a href="msgPhotographer.php?user_id=<?php echo $row['user_id'];?>" class="btn btn-outline-success btn-sm" style="position: absolute; top:  350px; left: 470px;">Send Message</a>
                                    <a href="bookEvent.php?photographer_id=<?php echo $row['user_id'];?>" class="btn btn-outline-info btn-sm" style="position: absolute; top:  350px; left: 718px;">Book Event</a>
                                    <a href="samplePic.php?user_id=<?php echo $row['user_id'];?>" class="btn btn-outline-warning btn-sm" style="position: absolute; top:  350px; left: 590px;">Sample Pictures</a>
                                    <a href="deactivateAccount.php?user_id=<?php echo $row['user_id'];?>" onclick="return confirm('Are you sure you want to deactivate this customer?')" class="btn btn-outline-danger btn-sm" style="position: absolute; top:  350px; left: 817px;">Deactivate</a>
                                    </center>
                                    </div>
                                </div>
                            </div>
