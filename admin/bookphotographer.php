...
<head>
   <!-- Required meta tags-->
    ...
    <!-- Title Page-->
    <title>Film Me | Book Photographer</title>
                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            <h4 class="page-title pull-left">Book Photographers</h4>
            ...
            <div class="main-content-inner">
                <div class="row">
                    ...
                    <div class="col-12 mt-5">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="header-title">Photgraphers List</h4>
                            ...
                            if($result){
                              while($res = mysqli_fetch_array($result)) {     
                                echo "<tr>";
                                  ...
                                  echo "<td>".$res['residential_address']."</td>";
                                  echo "<td class=\"text-center\">
                                      <a class=\"btn btn-outline-info btn-sm btn-block\" href=\"addBooking2.php?photographer_id=$res[user_id]&&event_id=$_GET[event_id]&&customer_id=$_GET[customer_id]\">Add Booking</a>
                                      <a class=\"btn btn-outline-success btn-sm btn-block\"  href=\"msgCustomer.php?user_id=$res[user_id]\">Message photographer</a>
                                       </td>";
