            ...
            <div class="header-area">
                <div class="row align-items-center">
                    ...
                    <div class="col-md-6 col-sm-4 clearfix">
                        ...
                        <ul class="notification-area pull-right">
                           <a href="bookingsTable.php" style="margin-right: 20px;"><b>Bookings</b></a>
                        </ul>
                    </div>
                </div>
            </div>
<!-- header area end -->
    ...
    <form id="" action="addBooking.php" method="post">
      ...
      ?>
            ...
            <center>
              <a href="viewphotographer.php?user_id=<?php echo $photographer_id ?>">View Photographer Profile</a>
            </center>
      ...
      ?>
            ...
            <div class="form-group validate">
             ...
             <center>
              <a href="viewCustomer.php?user_id=<?php echo $customer_id ?>">View Customer Profile</a>
            </center>
      ...
      ?>
        ...
        <h4><u>Event Details</u></h4>
           ...
           <div class="form-group validate" hidden="hidden">
            ...
            <center>
              <a href="viewEvent.php?event_id=<?php echo $event_id ?>&&user_id=<?php echo $customer_id ?>">View Event Details</a>
            </center>
      ...
      <?php if ( $row['status']=='booked' ) { ?>
        ...
        <center>
          <h4 style="color: blue">Booked On <?php echo date('F j, Y',strtotime($row['status_date'])); ?></h4>
            <a class="btn btn-outline-primary btn-sm btn-block" href="bookingFinished.php?booking_id=<?php echo $row['booking_id'] ?>&&customer_id=<?php echo $row['customer_id'] ?>&&event_id=<?php echo $row['event_id'] ?>" onClick="return confirm('Are you sure you that this booking has been finished?' )">Booking Finished</a>
            <a class="btn btn-outline-success btn-sm btn-block" href="msgCustomer.php?user_id=<?php echo $row['customer_id'] ?>">Message Customer</a>

            <a class="btn btn-outline-success btn-sm btn-block" href="msgphotographer.php?user_id=<?php echo $row['photographer_id'] ?>">Message photographer</a>
            <a class="btn btn-outline-danger btn-sm btn-block" href="bookingCancel.php?booking_id=<?php echo $row['booking_id'] ?>&&customer_id=<?php echo $row['customer_id'] ?>&&event_id=<?php echo $row['event_id'] ?>" onClick="return confirm('Are you sure you want to cancel this booking? Once canceled it cannot be undone' )">Cancel Booking</a>
        </center>
        
      <?php }else if ($row['status']=='finished') {?>

         <center>
          <h4 style="color: #2ecc71">Finished On <?php echo date('F j, Y',strtotime($row['status_date'])); ?></h4>
           
            <a class="btn btn-outline-success btn-sm btn-block" href="msgCustomer.php?user_id=<?php echo $row['customer_id'] ?>">Message Customer</a>
            <a class="btn btn-outline-success btn-sm btn-block" href="msgphotographer.php?user_id=<?php echo $row['photographer_id'] ?>">Message photographer</a>
            <a class="btn btn-block btn-sm btn-outline-secondary" href="adminPanel.php">Cancel</a>
      ...
      <?php  }else{ ?>
        ...
        <center>
          <h4 style="color: red">Canceled On <?php echo date('F j, Y',strtotime($row['status_date'])); ?></h4>
            <a class="btn btn-outline-danger btn-sm btn-block" href="deleteBooking.php?booking_id=<?php echo $row['booking_id'] ?>" onClick="return confirm('Are you sure you want to delete this booking? Once deleted it cannot be undone')">Delete Booking</a>
            <a class="btn btn-outline-success btn-sm btn-block" href="msgCustomer.php?user_id=<?php echo $row['customer_id'] ?>">Message Customer</a>
            <a class="btn btn-outline-success btn-sm btn-block" href="msgphotographer.php?user_id=<?php echo $row['photographer_id'] ?>">Message photographer</a>
            <a class="btn btn-block btn-sm btn-outline-secondary" href="adminPanel.php">Cancel</a>
