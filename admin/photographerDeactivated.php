...
<head>
   <!-- Required meta tags-->
    ...
    <!-- Title Page-->
    <title>Film Me | Deactivated Photographer</title>
                    ...
                    <nav>
                        <ul class="metismenu" id="menu">
                            ...
                            <li>
                             ...
                             <li class="active"><a href="photographerDeactivated.php"><i class="ti-na"></i> <span>Deactivated Photographer</span></a></li>
                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            <h4 class="page-title pull-left">Deactivated Customer</h4>
                            ...
                            if($result){
                              while($res = mysqli_fetch_array($result)) {     
                                echo "<tr>";
                                  ...
                                  echo "<td>  <a class=\"btn btn-outline-success btn-sm btn-block\" href=\"activateAccount.php?user_id=$res[user_id]\" onclick=\"return confirm('Are you sure want to activate this account?')\">Activate</a></td>";
                                 echo "</tr>";                                   
                              }
                            }?>
                                        </tbody>
