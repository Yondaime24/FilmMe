...
<head>
   <!-- Required meta tags-->
    ...
    <!-- Title Page-->
    <title>Film Me | Booked Bookings</title>
                        ...
                        <ul class="metismenu" id="menu">
                            ...
                            <li class="active">
                                ...
                                <ul class="collapse">
                                    ...
                                    <li class="active"><a href="bookedBookings.php">Booked</a></li>
                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            <h4 class="page-title pull-left">Booked Bookings</h4>
                              ...
                              while($res = mysqli_fetch_array($result)) {     
                                ...
                                if ($res['status']=='booked') {
                                     ...
                                     echo "<td class=\"text-center\">
                                      <a class=\"btn btn-outline-info btn-sm btn-block\" href=\"viewBooking.php?booking_id=$res[booking_id]&&customer_id=$res[customer_id]&&event_id=$res[event_id]&&photographer_id=$res[photographer_id]\">View</a>
                                     <a class=\"btn btn-outline-primary btn-sm btn-block\" href=\"bookingFinished.php?booking_id=$res[booking_id]&&customer_id=$res[customer_id]&&event_id=$res[event_id]\" onClick=\"return confirm('Are you sure you that this booking has been finished?' )\">Booking Finished</a>
                                      <a class=\"btn btn-outline-success btn-sm btn-block\" href=\"msgCustomer.php?user_id=$res[customer_id]\">Message Customer</a>
                                      <a class=\"btn btn-outline-success btn-sm btn-block\" href=\"msgphotographer.php?user_id=$res[photographer_id]\">Message photographer</a>
                                      <a class=\"btn btn-outline-danger btn-sm btn-block\" href=\"bookingCancel.php?booking_id=$res[booking_id]&&customer_id=$res[customer_id]&&event_id=$res[event_id]\" onClick=\"return confirm('Are you sure you want to cancel this booking? Once canceled it cannot be undone' )\">Cancel Booking</a>
                                       </td>";
                                }else if ($res['status']=='finished') {
                                     echo "<td style=\"color: #2ecc71;\">".$res['status']."</td>";
                                     echo "<td class=\"text-center\">
                                      <a class=\"btn btn-outline-info btn-sm btn-block\" href=\"viewBooking.php?booking_id=$res[booking_id]&&customer_id=$res[customer_id]&&event_id=$res[event_id]&&photographern_id=$res[photographer_id]\">View</a>
                                      <a class=\"btn btn-outline-success btn-sm btn-block\" href=\"msgCustomer.php?user_id=$res[customer_id]\">Message Customer</a>
                                      <a class=\"btn btn-outline-success btn-sm btn-block\" href=\"msgphotographer.php?user_id=$res[photographer_id]\">Message photographer</a>
                                       </td>";
                                }else{
                                  ...
                                  echo "<td class=\"text-center\">
                                      ...
                                      <a class=\"btn btn-outline-success btn-sm btn-block\" href=\"msgCustomer.php?user_id=$res[customer_id]\">Message Customer</a>
                                      <a class=\"btn btn-outline-success btn-sm btn-block\" href=\"msgphotographer.php?user_id=$res[photographer_id]\">Message photographer</a>
                                      <a class=\"btn btn-outline-danger btn-sm btn-block\" href=\"deleteBooking.php?booking_id=$res[booking_id]\" onClick=\"return confirm('Are you sure you want to delete this booking? Once deleted it cannot be undone' )\">Delete Booking</a>
                                  </td>";
