...
<!-- header area end -->
   ...
   ?>
							        <form id="pricingform" action="pricing.php" method="post">

							       	<div class="form-group validate" hidden="hidden">
							            <label for="event_price" class="control-label mb-1">Pricing Id</label>
							            <input id="event_price" type="text" name="pricing_id" class="form-control" value="<?php echo $row['pricing_id']; ?>">
							        </div>

							        <div class="form-group validate">
							            <label for="event_price" class="control-label mb-1">Price Per Event</label>
							            <input id="event_price" type="text" name="event_price" class="form-control" value="<?php echo $row['event_price']; ?>">
							        </div>
							        <br>

							        <div class="form-group validate">
							            <label for="tax_price" class="control-label mb-1">Photographer Tax</label>
							            <input id="tax_price" type="text" name="tax_price" class="form-control" value="<?php echo $row['tax_price']; ?>">
							        </div>
							       
							        </ul>
							        <br>
                         <div class="submit-btn-area">
                            <button id="form_submit" type="submit" name="updatePricing">Update <i class="ti-arrow-right"></i></button>
                        </div>
                                    </form>
    <?php } ?>
                                </div>
