 ...
 <?php 
                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            <h4 class="page-title pull-left">Photographer Payments</h4>
     ...
     <?php } ?>
            ...
            <div class="main-content-inner">
                ...
                $query=mysqli_query($db,"SELECT * FROM `users` WHERE `user_id`='".$res['photographer_id']."'")or die(mysqli_error());
                  while($row=mysqli_fetch_array($query)){
                ...
                $query=mysqli_query($db,"SELECT * FROM `events` WHERE `event_id`='".$res['event_id']."'")or die(mysqli_error());
                  while($row=mysqli_fetch_array($query)){
                                  ...
                                  echo "<td>".date('F j, Y / g:i a',strtotime($res['date_paid']))."</td>";
                                 
                                   echo "<td>&#8369;".$res['amount']."</td>";

                                    echo "<td><a class=\"btn btn-outline-info btn-sm btn-block\" href=\"viewPayment.php?customer_id=$res[customer_id]&&event_id=$res[event_id]&&photographer_id=$res[photographer_id]\">View Details</a></td>";
