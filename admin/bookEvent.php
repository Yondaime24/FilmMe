...
<head>
   <!-- Required meta tags-->
    ...
    <!-- Title Page-->
    <title>Film Me | Select Events</title>
                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            <h4 class="page-title pull-left">Select Events</h4>
                              ...
                              while($res = mysqli_fetch_array($result)) {     
                                ...
                                // if ($res['status']=='pending') {
                                  ...
                                  echo "<td class=\"text-center\">
                                      <a class=\"btn btn-outline-info btn-sm btn-block\" href=\"addBooking.php?event_id=$res[event_id]&&user_id=$res[user_id]&&photographer_id=$_GET[photographer_id]\">Add Booking</a>
