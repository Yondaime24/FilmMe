...
<!-- header area start -->
    ...
    <div class="login-area login-s2">
        <div class="container">
            <div class="login-box"> 
                <form id="register" action="addphotographer.php" method="post" enctype="multipart/form-data">
                    <div class="login-form-head">
                        <h4>Photographer Register</h4>
                          ...
                          <div class="form-group" style="width: 700px; position: absolute; top: 250px; right: 310px;">
                           ...
                           <div class="form-group" style="width: 700px; position: absolute; top: 450px; right: 310px;">
                            ...
                            <div class="form-group" style="width: 700px; position: absolute; top: 850px; right: 400px;">
                              <span style="position: absolute; top: 130px; left: 320px">Please Add Three Sample Pictures</span>
                              <div class="form-row">
                   ...
                   <br><br><br><br>   <br><br><br><br>   <br><br><br><br> <br><br><br><br> <br><br><br><br>
                        <div class="submit-btn-area" style="margin-top: 550px;">
                            <button id="form_submit" type="submit" name="adminaddphotographer">Add <i class="ti-arrow-right"></i></button>
                        </div>
                    </div>
                </form>
            </div>
