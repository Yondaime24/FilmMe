                    ...
                    <nav>
                        <ul class="metismenu" id="menu">
                            ...
                            <li class="active">
                                ...
                                <ul class="collapse">
                                    <li class="active"><a href="customer.php">View Customer</a></li>
                            ...
                            <div class="col-lg-12">
                                <div class="au-card recent-report">
                                    <div class="au-card-inner">
                                        <h3 class="title-2 text-center"> <u> Customer Profile </u></h3>
                                    <br>
                                    <?php if($row['photo'] != ""): ?>
                                    ...
                                    <a href="customer.php" class="btn btn-outline-primary btn-sm" style="position: absolute; top:  350px; left: 448px;">Return</a>
                                    <a href="msgCustomer.php?user_id=<?php echo $row['user_id'];?>" class="btn btn-outline-success btn-sm" style="position: absolute; top:  350px; left: 520px;">Send Message</a>
                                    <a href="addEvent.php?user_id=<?php echo $row['user_id'];?>" class="btn btn-outline-info btn-sm" style="position: absolute; top:  350px; left: 640px;">Add Event</a>
                                    <a href="deactivateAccount.php?user_id=<?php echo $row['user_id'];?>" onclick="return confirm('Are you sure you want to deactivate this customer?')" class="btn btn-outline-danger btn-sm" style="position: absolute; top:  350px; left: 733px;">Deactivate</a>
                                    </center>
                                    </div>
                                </div>
                            </div>
