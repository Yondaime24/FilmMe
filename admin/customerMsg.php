    ...
    <div class="login-area">
      ...
      ?>
            ...
            <div class="form-group" hidden="hidden">
                ...
                <input id="userID" name="customer_id" type="text" class="form-control" value="<?php echo $row['customer_id']; ?>" readonly>
            </div>

             <div class="form-group">
                <label for="locId" class="control-label mb-1">From Customer:</label>
                <input id="locId" type="text" class="form-control" value="<?php echo $row['full_name']; ?>" readonly>
            </div>

            <div class="form-group">
                <label for="contactNumber" class="control-label mb-1">Customer Contact Number:</label>
                 <input id="contactNumber" type="text" class="form-control" value="<?php echo $row['contact_number']; ?>" readonly="readonly">
            </div>

             <div class="form-group">
                <label for="inputNumber" class="control-label mb-1">Customer Email Address:</label>
          ...
          <?php }?>
                        <div class="submit-btn-area">
                            <button id="form_submit" type="submit" name="admintoCustomer">Send Reply <i class="ti-arrow-right"></i></button>
                        </div>
