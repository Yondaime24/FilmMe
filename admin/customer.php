     ...
     <?php } ?>
            ...
            <div class="main-content-inner">
                <div class="row">
                   ...
                   <?php
                          $query = "SELECT * FROM users WHERE user_type='customer' && status = 'active' ORDER BY date_registered ASC";
                              ...
                              while($res = mysqli_fetch_array($result)) {     
                                echo "<tr>";
                                  ...
                                  echo "<td class=\"text-center\">
                                      <a class=\"btn btn-outline-primary btn-sm btn-block\" href=\"viewCustomer.php?user_id=$res[user_id]\">View</a>
                                      <a class=\"btn btn-outline-info btn-sm btn-block\"  href=\"addEvent.php?user_id=$res[user_id]\">Add Event</a>
                                      <a class=\"btn btn-outline-success btn-sm btn-block\"  href=\"msgCustomer.php?user_id=$res[user_id]\">Message</a>
                                      <a class=\"btn btn-outline-danger btn-sm btn-block\" onclick=\"return confirm('Are you sure you want to deactivate this customer?')\" href=\"deactivateAccount.php?user_id=$res[user_id]\">Deactivate</a>
                                       </td>";
                                 echo "</tr>";                                   
                              }
                            }?>
