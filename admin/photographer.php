                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            <h4 class="page-title pull-left">Photographers</h4>
            ...
            <div class="main-content-inner">
                <div class="row">
                    ...
                    <div class="col-12 mt-5">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="header-title">Photographers List</h4>
                                <div class="data-tables datatable-primary">
                   <?php
                          $query = "SELECT * FROM users WHERE user_type='photographer' && status = 'active' ORDER BY date_registered ASC";
                              ...
                              while($res = mysqli_fetch_array($result)) {     
                                echo "<tr>";
                                  ...
                                  echo "<td class=\"text-center\">
                                      <a class=\"btn btn-outline-primary btn-sm btn-block\" href=\"viewPhotographer.php?user_id=$res[user_id]\">View</a>
                                      <a class=\"btn btn-outline-info btn-sm btn-block\"  href=\"bookEvent.php?photographer_id=$res[user_id]\">Book Event</a>

                                       <a href=\"samplePic.php?user_id=$res[user_id]\" class=\"btn btn-outline-warning btn-sm\" style=\"margin-top: 8px; margin-bottom: 8px;\">Sample Pictures</a>

                                      <a class=\"btn btn-outline-success btn-sm btn-block\"  href=\"msgPhotographer.php?user_id=$res[user_id]\">Message</a>
                                      <a class=\"btn btn-outline-danger btn-sm btn-block\" onclick=\"return confirm('Are you sure you want to deactivate this musician?')\" href=\"deactivateAccount.php?user_id=$res[user_id]\">Deactivate</a>
                                       </td>";
                                 echo "</tr>";                                   
                              }
                            }?>
